...
public class DriveCommands {
    ...
    public static Command joystickDrive(
        ...
        return Commands.run(
                () -> {
                    ...
                    drive.runTeleOpVelocity(ChassisSpeeds.fromFieldRelativeSpeeds(
                            speeds,
    ...
    public static Command pointTowardsReefCommand(Drive drive, DoubleSupplier xSupplier, DoubleSupplier ySupplier) {
        ...
        return joystickDriveAtAngle(drive, xSupplier, ySupplier, () -> {
            ...
            double angle = drive.getPose()
                    .relativeTo(targetCenter)
                    .getTranslation()
                    .getAngle()
                    .getDegrees();
