...
public class DriveTarget {
    ...
    static {
        blueReefStartTargets.put(0, getScoreingLocations(blueReefCenter, reefOffset + startOffset, 60, true));
        blueReefStartTargets.put(1, getScoreingLocations(blueReefCenter, reefOffset + startOffset, 0, true));
        blueReefStartTargets.put(2, getScoreingLocations(blueReefCenter, reefOffset + startOffset, -60, true));
        blueReefStartTargets.put(3, getScoreingLocations(blueReefCenter, reefOffset + startOffset, -120, false));
        blueReefStartTargets.put(4, getScoreingLocations(blueReefCenter, reefOffset + startOffset, 180, false));
        blueReefStartTargets.put(5, getScoreingLocations(blueReefCenter, reefOffset + startOffset, 120, false));
    }

    private static final Pose2d blueProccesorTag =
            aprilTagLayout.getTagPose(16).get().toPose2d();
    private static final Pose2d blueProcessorEndPose =
            new Pose2d(blueProccesorTag.getX(), blueProccesorTag.getY() + 0.7, Rotation2d.fromDegrees(-90));
    ...
    static {
        redReefStartTargets.put(0, getScoreingLocations(redReefCenter, startOffset + reefOffset, -120, true));
        redReefStartTargets.put(1, getScoreingLocations(redReefCenter, startOffset + reefOffset, 180, true));
        redReefStartTargets.put(2, getScoreingLocations(redReefCenter, startOffset + reefOffset, 120, true));
        redReefStartTargets.put(3, getScoreingLocations(redReefCenter, startOffset + reefOffset, 60, false));
        redReefStartTargets.put(4, getScoreingLocations(redReefCenter, startOffset + reefOffset, 0, false));
        redReefStartTargets.put(5, getScoreingLocations(redReefCenter, startOffset + reefOffset, -60, false));
    }

    private static final Pose2d[] redSourceEndPoses = {
        new Pose2d(16.437, 7.038, Rotation2d.fromDegrees(126)), new Pose2d(16.437, 1.013, Rotation2d.fromDegrees(-126))
    };

    private static final Pose2d[] redSourceStartPoses = {
        new Pose2d(16.143, 6.634, Rotation2d.fromDegrees(126)), new Pose2d(16.143, 1.418, Rotation2d.fromDegrees(-126))
    };

    private static final Pose2d redProcessorEndPose = new Pose2d(11.561, 7.601, Rotation2d.fromDegrees(90));
