...
public class Drive extends SubsystemBase {
    ...
    @AutoLogOutput
    public Trigger autoElevator = new Trigger(() -> secondStagePathfinding);

    @AutoLogOutput
    public Trigger readyAutoScore = new Trigger(() -> nearTarget(targets[1], .01));
    ...
    public Command getLeftCoralDriveCommand(BooleanSupplier condition) {
        return sequence(
                ...
                defer(() -> AutoBuilder.pathfindToPose(targets[0], teleopPathConstraints)
